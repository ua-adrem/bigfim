...
public class EclatMinerSetCountMapper extends
		Mapper<IntArrayWritable, IntArrayWritable, Text, LongWritable> {
	...
	@Override
	public void map(IntArrayWritable key, IntArrayWritable value,
	...
	private void mineSubTree(Context context) {
		...
		SetReporter.HadoopPerLevelCountReporter reporter = new SetReporter.HadoopPerLevelCountReporter(
				context);
