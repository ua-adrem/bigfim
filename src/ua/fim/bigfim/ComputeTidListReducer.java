...
public class ComputeTidListReducer extends
		Reducer<Text, IntArrayWritable, IntArrayWritable, IntArrayWritable> {
	...
	private void assignToBucket(Text key, Map<Integer, List<Integer>> map,
			int totalTids) throws IOException, InterruptedException {
