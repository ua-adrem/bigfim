...
/**
 * This class implements the Mapper for the first MapReduce cycle for
 * Dist-Eclat.It reads the database in vertical format and reports only the
 * frequent singletons. Each line in the database file should be formated as:
 * 'itemId<tab>comma-separated-tids'
 * 
 * @author Sandy Moens & Emin Aksehirli
 */
public class ItemReaderMapper extends
