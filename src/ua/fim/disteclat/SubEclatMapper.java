 ...
 * to obtain frequent itemsets.This class reports the mined itemsets as
 * compressed tree strings.
 * 
 * @author Sandy Moens & Emin Aksehirli
 */
public class SubEclatMapper extends
		SubEclatMapperBase<LongWritable, Text, Text, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		while (st.hasMoreElements()) {
			SetReporter reporter = new SetReporter.HadoopTreeStringReporter(
					context);
