...
public interface PrefixGroupReporter {
  ...
  public static class Extension {
    ...
    public String toString() {
      ...
      return name + DELIMITER_SUPPORT + support + DELIMITER_SUBEXTENSIONSLIST
  ...
  public static class HadoopPGReporter implements PrefixGroupReporter {
    ...
    public void report(String prefix, List<Extension> extensions) {
      try {
        ...
        context
            .write(new Text(PREFIX_GROUP + " " + prefix), new ObjectWritable(builder.substring(0, builder.length())));
      } catch (IOException e) {
        e.printStackTrace();
