...
/**
 * This class implements the Reducer of the third MapReduce cycle for
 * Dist-Eclat. It accumulates the level counts for each of the levels and
 * reports the total sum for each level.
 * 
 * @author Sandy Moens & Emin Aksehirli
 */
public class SubEclatReducerSetCount extends
