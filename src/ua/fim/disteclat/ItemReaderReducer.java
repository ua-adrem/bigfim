...
/**
 * This class implements the Reducer for the first MapReduce cycle for
 * Dist-Eclat. It receives the complete set of frequent singletons from the
 * different mappers. The frequent singletons are sorted on ascending frequency
 * and distributed among a number of map-tasks.
 * 
 * @author Sandy Moens & Emin Aksehirli
 */
public class ItemReaderReducer extends
		Reducer<Text, IntArrayWritable, Text, Writable> {
	 ...
	 */
	private void writeSingletonsOrders(List<String> sortedSingletons)
	...
	/**
	 * Writes the singletons distribution to file OSingletonsDistribution. The
	 * distribution is obtained using Round-Robin allocation.
	 * 
	 * @param sortedSingletons
	 ...
	 * @throws InterruptedException
	 */
	private void writeSingletonsDistribution(List<String> sortedSingletons)
			throws IOException, InterruptedException {
